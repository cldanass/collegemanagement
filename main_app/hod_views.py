...
def delete_course(request, course_id):
    ...
    try:
        ...
        messages.error(
            request, "Sorry, some students are assigned to this course already change the student course and try again")
...
def delete_session(request, session_id):
    ...
    try:
        ...
        messages.error(
            request, "There are students assigned to this session.")
